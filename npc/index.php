                    ...
                    <div class="login-space">
                        ...
                        <div class="sign-up-form">
                            <form action="register.php" method="post" enctype="multipart/form-data">
                                <div class="group"> <label for="user" class="label">Name</label> <input id="user" name="name" type="text" class="input" placeholder="Name"> </div>
                                ...
                                <div class="hr"></div>
                                <div class="foot"> <label for="tab-1">Got an Account?</label> </div>
                            </form>
                        </div>
                    </div>
                </div>
